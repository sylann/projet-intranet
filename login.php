...
/*
\ Brief : Vérifie si le login & le password fourni sont bon
\ Entrée : login – string
\ password – string
\ Sortie : identifiant – entier / false
\ Si le couple Login / Password correspond à un utilisateur de la base, renvoie son Id
\ Sinon, renvoie Faux
*/
